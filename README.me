...
- Create a frontend interface with a dice selector and roll button
- Build a backend API that returns random results based on selected dice
- Implement integration between frontend and backend
- Write clean, well-structured, and beginner-friendly code
